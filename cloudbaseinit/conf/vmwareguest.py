...
class VMwareGuestConfigOptions(conf_base.Options):

    """Config options available for the Packet metadata service."""

    def __init__(self, config):
        super(VMwareGuestConfigOptions, self).__init__(config,
                                                       group="vmwareguest")
        self._options = [
            cfg.StrOpt(
                'vmware_rpctool_path',
    ...
    def register(self):
        ...
        group = cfg.OptGroup(self.group_name, title='VMwareGuest Options')
